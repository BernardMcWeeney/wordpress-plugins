...
Greenberry is a modular WordPress plugin for site administration, publishing, forms, newsletters, and branded admin experiences. Each feature area is built as a separate module, so site owners can enable only the tools they need from the Greenberry admin screen.
...
Install and activate the plugin, then open **Greenberry** in the WordPress admin menu to turn modules on or off.
