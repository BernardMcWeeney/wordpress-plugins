 ...
 * Description: A modular WordPress plugin with GDPR-aware Newsletter, Forms, Social, Stats, Admin Colours, Admin Login, and Category Featured Image modules.
 * Version: 1.4.0
...
define( 'GREENBERRY_VERSION', '1.4.0' );
